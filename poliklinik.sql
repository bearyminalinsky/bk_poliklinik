...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 13, 2024 at 05:35 PM
...
(4, 'beomgyu', 'gtw', '87817491847918490', NULL);
...
(1, 'soobin', 'soobin', '123', 'pasien'),
(2, 'taehyun', 'taehyun', '123', 'admin'),
(3, 'beomgyu', 'beomgyu', '123', 'dokter');
...
--
ALTER TABLE `daftar_poli`
  ADD CONSTRAINT `daftar_poli_ibfk_1` FOREIGN KEY (`id_pasien`) REFERENCES `pasien` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `detail_periksa`
  ...
  ADD CONSTRAINT `detail_periksa_ibfk_2` FOREIGN KEY (`id_obat`) REFERENCES `obat` (`id`) ON DELETE CASCADE;
